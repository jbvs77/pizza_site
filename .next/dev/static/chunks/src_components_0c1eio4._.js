...
"[project]/src/components/StoryGallery.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function StoryGallery() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StoryGallery.useEffect": ()=>{
            const timer = setInterval({
                "StoryGallery.useEffect.timer": ()=>{
                    setCurrent({
                        "StoryGallery.useEffect.timer": (prev)=>(prev + 1) % VIDEOS.length
                    }["StoryGallery.useEffect.timer"]);
                }
            }["StoryGallery.useEffect.timer"], 4000);
            return ({
                "StoryGallery.useEffect": ()=>clearInterval(timer)
            })["StoryGallery.useEffect"];
        }
    }["StoryGallery.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StoryGallery.useEffect": ()=>{
            videoRefs.current.forEach({
                "StoryGallery.useEffect": (video, idx)=>{
                    if (!video) return;
                    if (idx === current) {
                        video.currentTime = 0;
                        video.play().catch({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: VIDEOS.map((vid, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(StoryGallery, "9fSp4HnB0++JIyVlp8lRjD6Wi24=");
_c = StoryGallery;
var _c;
__turbopack_context__.k.register(_c, "StoryGallery");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_components_0c1eio4._.js.map